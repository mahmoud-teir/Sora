...
private val themeResources: Map<AppTheme, Int> = mapOf(
    ...
    AppTheme.CLOUDFLARE to R.style.Theme_Tachiyomi,
    AppTheme.COTTONCANDY to R.style.Theme_Tachiyomi,
    AppTheme.DOOM to R.style.Theme_Tachiyomi,
    AppTheme.MATRIX to R.style.Theme_Tachiyomi,
    AppTheme.MOCHA to R.style.Theme_Tachiyomi,
    AppTheme.SAPPHIRE to R.style.Theme_Tachiyomi,
)
