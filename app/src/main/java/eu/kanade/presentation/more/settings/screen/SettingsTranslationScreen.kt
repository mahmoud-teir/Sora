...
object SettingsTranslationScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            ...
            Preference.PreferenceItem.ListPreference(
                ...
                title = stringResource(MR.strings.pref_reader_font),
    ...
    private fun getTranslationLangGroup(
        ...
        return Preference.PreferenceGroup(
            title = stringResource(MR.strings.pref_group_setup),
    ...
    private fun getTranslatioEngineGroup(
        ...
        return Preference.PreferenceGroup(
            title = stringResource(MR.strings.pref_group_engine),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.ListPreference(
                    preference = translationPreferences.translationEngine(),
                    title = stringResource(MR.strings.pref_translator_engine),
                ...
                Preference.PreferenceItem.EditTextPreference(
                    ...
                    subtitle = stringResource(MR.strings.pref_sub_engine_api_key),
                    title = stringResource(MR.strings.pref_engine_api_key),
                ),
            ),
        )
    }
    ...
    private fun getTranslatioAdvancedGroup(
        ...
        return Preference.PreferenceGroup(
            title = stringResource(MR.strings.pref_group_advanced),
            preferenceItems = persistentListOf(
                Preference.PreferenceItem.EditTextPreference(
                    preference = translationPreferences.translationEngineModel(),
                    title = stringResource(MR.strings.pref_engine_model),
                ),
                Preference.PreferenceItem.EditTextPreference(
                    preference = translationPreferences.translationEngineTemperature(),
                    title = stringResource(MR.strings.pref_engine_temperature),
                ),
                Preference.PreferenceItem.EditTextPreference(
                    preference = translationPreferences.translationEngineMaxOutputTokens(),
                    title = stringResource(MR.strings.pref_engine_max_output),
                ),
            ),
        )
    }
